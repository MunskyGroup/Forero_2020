...
for iq = 1:200
    ...
    mh_smpl = [mh_smpl;mh_smpli(1:end-1,:)];
    mh_value = [mh_value;mh_valuei(1:end-1,:)];
    accepti

    save(sv_file,'mh_smpl','mh_value','-append')
    saveas(sv_file,'mh_smpl','mh_value')
end

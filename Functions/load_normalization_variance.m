function [mrna,ser5,rnap,mrna_rnap,mrna_ser5,ser5_rnap,G1_rnap,G1_ser5,G1_mrna] = load_normalization_variance(rezero_acc,acc_type,cc_type,cc_offset)
...
for j = 1:20
    ...
    C(1:round(length(C)/2)-1,:) = C(1:round(length(C)/2)-1,:)./(1:1:Nt-1)'; 
       ...
       % mod_ser5_100 = mod_ser5_100/mod_ser5_100(2);
        ...
        mod_mrna_rnap_100 = mod_mrna_rnap_100(((length(mod_mrna_rnap_100)+1)/2-cc_offset):((length(mod_mrna_rnap_100)+1)/2)+cc_offset);
       ...
       % mod_mrna_rnap_100 = mod_mrna_rnap_100/mod_mrna_rnap_100(11);
        if j == 1
        ...
        mod_ser5_rnap_100 = mod_ser5_rnap_100(((length(mod_ser5_rnap_100)+1)/2-cc_offset):((length(mod_ser5_rnap_100)+1)/2)+cc_offset);
       ...
       % mod_ser5_rnap_100 = mod_ser5_rnap_100/mod_ser5_rnap_100(11);
        if j == 1
        ...
        mod_mrna_ser5_100 = mod_mrna_ser5_100(((length(mod_mrna_ser5_100)+1)/2-cc_offset):((length(mod_mrna_ser5_100)+1)/2)+cc_offset);
       ...
       % mod_mrna_ser5_100 = mod_mrna_ser5_100/mod_mrna_ser5_100(11);
        if j == 1
...
[g_mr, g_ms, g_sr] =  get_g0_cc(mean(mrna_rnap100,2)',mean(mrna_ser5100,2)',mean(ser5_rnap100,2)',cc_type);
 ...
 mrna_rnap.mn_cc = mean(mrna_rnap100,2)./g_mr;
 mrna_rnap.sem_cc = (std(mrna_rnap100,0,2)./g_mr)./sqrt(20);
 
 mrna_ser5.mn_cc = mean(mrna_ser5100,2)./g_ms;
 mrna_ser5.sem_cc = (std(mrna_ser5100,0,2)./g_ms)./sqrt(20);
 
 ser5_rnap.mn_cc = mean(ser5_rnap100,2)./g_sr;
 ser5_rnap.sem_cc = (std(ser5_rnap100,0,2)./g_sr)./sqrt(20);

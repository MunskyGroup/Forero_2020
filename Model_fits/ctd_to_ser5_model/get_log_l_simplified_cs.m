function err = get_log_l_simplified_cs(pars,mrna,ser5,rnap,mrna_rnap,mrna_ser5,ser5_rnap,par_fixed,par_change)
parameters = par_fixed;

parameters(par_change) = pars;
[sigred,~,means,SIGc] = get_ac_and_cc_mod_cs(parameters);

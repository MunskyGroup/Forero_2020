function err = get_log_l_simplified_2s(pars,mrna,ser5,rnap,mrna_rnap,mrna_ser5,ser5_rnap,par_fixed,par_change)
parameters = par_fixed;
parameters(par_change) = pars;
[sigred,~,means,SIGc] = get_ac_and_cc_mod_2s(parameters);
...
cv12 = 1/parameters(9)*sigred(2,1);
cv13 = 1/parameters(10)*sigred(3,1);
cv23 = 1/parameters(11)*sigred(6,1);

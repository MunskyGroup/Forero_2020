...
% with computational tools adapted from:
...
%    2) change your current working directory to "Bioprotocol_Codes"
%    3) right click each section one at a time and select "Evaluate Current
%       Section"
...
% Upon running this code, the model will be searched using a combination of
% genetic algorithms and simplex searches starting from different intial
% parameter guesses.  The code could take severalminutes to complete
% depending upon your conmputer.  For the default model and settings, the
% final negative log-likelihood value should reach a minimum value of
% approximately 14.558

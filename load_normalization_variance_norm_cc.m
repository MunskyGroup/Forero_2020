function [mrna,ser5,rnap,mrna_rnap,mrna_ser5,ser5_rnap,G1_rnap,G1_ser5,G1_mrna] = load_normalization_variance_norm_cc(rezero_acc)
...
for j = 1:20
    ...
    C(1:round(length(C)/2)-1,:) = C(1:round(length(C)/2)-1,:)./(1:1:Nt-1)'; 
        ...
        [G1s_rnap(j),G1s_ser5(j),G1s_mrna(j)] = get_g0(mod_rnap_100,mod_ser5_100,mod_mrna_100,'G0');
end
